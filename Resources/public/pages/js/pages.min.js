!function ($) {
    "use strict";
    var Pages = function () {
        this.VERSION = "2.2.0", this.AUTHOR = "Revox", this.SUPPORT = "support@revox.io", this.pageScrollElement = "html, body", this.$body = $("body"), this.setUserOS(), this.setUserAgent()
    };
    Pages.prototype.setUserOS = function () {
        ...
        if (requestMethod) requestMethod.call(element); else if ("undefined" != typeof window.ActiveXObject) {
        ...
        var elem = $(".pg-colors").length ? $(".pg-colors") : $('<div class="pg-colors"></div>').appendTo("body"),
            ...
            color = colorElem.css("background-color"), rgb = color.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/),
        ...
        $(".dropdown-default", context).each(function () {
            var btn = $(this).find(".dropdown-menu").siblings(".dropdown-toggle"), offset = 0,
        ...
        $('[data-init-reponsive-tabs="dropdownfx"]').each(function () {
            ...
            for (var content = '<select class="cs-select cs-skin-slide full-width" data-init-plugin="cs-select">', i = 1; i <= drop.children("li").length; i++) {
                var li = drop.children("li:nth-child(" + i + ")"), selected = "";
        ...
        $.fn.select2 && $('[data-init-plugin="select2"]', context).each(function () {
            $(this).select2({minimumResultsForSearch: "true" == $(this).attr("data-disable-search") ? -1 : 1}).on("select2:open", function () {
                $.fn.scrollbar && $(".select2-results__options").scrollbar({ignoreMobile: !1})
            })
        })
    }, Pages.prototype.initScrollBarPlugin = function (context) {
        $.fn.scrollbar && $(".scrollable", context).scrollbar({ignoreOverlay: !1})
    }, Pages.prototype.initListView = function (context) {
        $.fn.ioslist && $('[data-init-list-view="ioslist"]', context).ioslist(), $.fn.scrollbar && $(".list-view-wrapper", context).scrollbar({ignoreOverlay: !1})
    ...
    SelectFx.prototype.options = {
        newTab: !0, stickyPlaceholder: !0, container: "body", onChange: function (el) {
        ...
        var options = "", createOptionHTML = function (el) {
        ...
        var backdrop = this.selEl.querySelector(".cs-backdrop"),
            ...
            mask = container.querySelector(".dropdown-mask"), csOptions = this.selEl.querySelector(".cs-options"),
            csPlaceholder = this.selEl.querySelector(".cs-placeholder"), csPlaceholderWidth = csPlaceholder.offsetWidth,
            csPlaceholderHeight = csPlaceholder.offsetHeight, csOptionsWidth = csOptions.scrollWidth;
        if (this._isOpen()) {
            -1 !== this.current && (this.selPlaceholder.textContent = this.selOpts[this.current].textContent);
            var dummy = this.selEl.data, parent = dummy.parentNode;
            ...
            var contentHeight = csOptions.offsetHeight, originalHeight = csPlaceholder.offsetHeight,
    ...
    function Plugin(option) {
        return this.filter(":input").each(function () {
            var $this = $(this), data = $this.data("pg.circularProgress"),
    ...
    $.fn.circularProgress = Plugin, $.fn.circularProgress.Constructor = Progress, $.fn.circularProgress.defaults = {value: 0}, $.fn.circularProgress.noConflict = function () {
    ...
    function Plugin(option) {
        return this.each(function () {
            var $this = $(this), data = $this.data("pg.portlet"), options = "object" == typeof option && option;
        ...
        if (refresh) {
            ...
            this.$loader.fadeOut(function () {
                if ($(this).remove(), "circle-lg" == _this.options.progress) {
                    var iconNew = toggle.find(".active"), iconOld = toggle.find(".fade");
    ...
    $.fn.portlet = Plugin, $.fn.portlet.Constructor = Portlet, $.fn.portlet.defaults = {
        ...
        var $this = $(this), $target = $this.closest(".panel");
        ...
        var $this = $(this), $target = $this.closest(".panel");
        $this.is("a") && e.preventDefault(), $target.data("pg.portlet") && $target.portlet({refresh: !0})
    ...
    var MobileView = function (element, options) {
        ...
        return self.options = $.extend(!0, {}, $.fn.pgMobileViews.defaults, options), self.element = $(element), self.element.on("click", function (e) {
            e.preventDefault();
            var data = self.element.data(), el = $(data.viewPort), toView = data.toggleView;
    ...
    function Plugin(option) {
        return this.each(function () {
            var $this = $(this), data = $this.data("pg.quickview"), options = "object" == typeof option && option;
    ...
    var Quickview = function (element, options) {
        ...
        $(this.options.notes).on("click", ".list > ul > li", function (e) {
            var note = $(this).find(".note-preview"), note = $(this).find(".note-preview");
    ...
    $.fn.quickview = Plugin, $.fn.quickview.Constructor = Quickview, $.fn.quickview.defaults = {
        ...
        if (Modernizr.csstransitions) $(elem).toggleClass("open"); else {
            var width = $(elem).width();
            $(elem).hasClass("open-ie") ? $(elem).stop().animate({right: 0}, 400, $.bez([.05, .74, .27, .99]), function () {
    ...
    function Plugin(option) {
        return this.each(function () {
            var $this = $(this), data = $this.data("pg.parallax"), options = "object" == typeof option && option;
    ...
    Parallax.VERSION = "1.0.0", Parallax.prototype.animate = function () {
        var scrollPos, pagecoverWidth = this.$element.height(), opacityKeyFrame = 50 * pagecoverWidth / 100,
            direction = "translateX";
        scrollPos = $(window).scrollTop(), direction = "translateY", this.$coverPhoto.css({transform: direction + "(" + scrollPos * this.options.speed.coverPhoto + "px)"}), this.$content.css({transform: direction + "(" + scrollPos * this.options.speed.content + "px)"}), scrollPos > opacityKeyFrame ? this.$content.css({opacity: 1 - scrollPos / 1200}) : this.$content.css({opacity: 1})
    };
    var old = $.fn.parallax;
    ...
    function Plugin(option) {
        return this.each(function () {
            var $this = $(this), data = $this.data("pg.sidebar"), options = "object" == typeof option && option;
    ...
    var Sidebar = function (element, options) {
        function sidebarMouseEnter(e) {
            ...
            return $.Pages.isVisibleSm() || $.Pages.isVisibleXs() ? !1 : void($(".close-sidebar").data("clicked") || _this.$body.hasClass("menu-pin") || (_this.cssAnimation ? (_this.$element.css({transform: menuOpenCSS}), _this.$body.addClass("sidebar-visible")) : _this.$element.stop().animate({left: "0px"}, 400, $.bez(_this.bezierEasing), function () {
        ...
        if (this.$element = $(element), this.$body = $("body"), this.options = $.extend(!0, {}, $.fn.sidebar.defaults, options), this.bezierEasing = [.05, .74, .27, .99], this.cssAnimation = !0, this.css3d = !0, this.sideBarWidth = 280, this.sideBarWidthCondensed = 210, this.$sidebarMenu = this.$element.find(".sidebar-menu > ul"), this.$pageContainer = $(this.options.pageContainer), this.$sidebarMenu.length) {
            "desktop" == $.Pages.getUserAgent() && this.$sidebarMenu.scrollbar({ignoreOverlay: !1}), Modernizr.csstransitions || (this.cssAnimation = !1), Modernizr.csstransforms3d || (this.css3d = !1), "undefined" == typeof angular && $(document).on("click", ".sidebar-menu a", function (e) {
                if ($(this).parent().children(".sub-menu") !== !1) {
                    var el = $(this), parent = $(this).parent().parent(), li = $(this).parent(),
    ...
    var old = $.fn.sidebar;
    $.fn.sidebar = Plugin, $.fn.sidebar.Constructor = Sidebar, $.fn.sidebar.defaults = {pageContainer: ".page-container"}, $.fn.sidebar.noConflict = function () {
    ...
    function Plugin(option) {
        return this.each(function () {
            var $this = $(this), data = $this.data("pg.search"), options = "object" == typeof option && option;
    ...
    $.fn.search = Plugin, $.fn.search.Constructor = Search, $.fn.search.defaults = {
        ...
        var $this = $(this), $target = $('[data-pages="search"]');
